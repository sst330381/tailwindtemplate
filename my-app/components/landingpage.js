    ...
    return ( 
      ...
      <main>
        <div className="relative isolate overflow-hidden">
          <svg
            className="absolute inset-0 -z-10 h-full w-full stroke-white/10 [mask-image:radial-gradient(100%_100%_at_top_right2c white2c transparent)]"
            aria-hidden="true"
          >
            <defs>
              <pattern
          ...
          <div className="mx-auto max-w-7xl px-6 pb-24 pt-10 sm:pb-40 lg:flex lg:px-8 lg:pt-40">
            <div className="mx-auto max-w-2xl flex-shrink-0 lg:mx-0 lg:max-w-xl lg:pt-8">
              ...
              <div className="mt-10 flex items-center gap-x-6">
                <a
                  href="#"
                  className="rounded-md bg-indigo-500 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-indigo-400 box boy bpa bpf"
                >
                  Get started
                </a>
                <a
              ...
              <div className="flex flex-col">
                ...
                <dd className="mt-1 flex flex-auto flex-col text-base leading-7 text-gray-300">
                  <p className="flex-auto">
                    ...
                    natus. Earum nihil deserunt eos quasi cupiditate. A
                    inventore et molestiae natus.
                  </p>
                  <p className="mt-6">
                    <a
                      href="#"
        ...
        <div className="relative isolate mt-32 px-6 py-32 sm:mt-56 sm:py-40 lg:px-8">
          ...
          <div
            ...
            aria-hidden="true"
          >
            <div className="aspect-[1108/632] w-[69.25rem] flex-none bg-gradient-to-r from-[#80caff] to-[#4f46e5] opacity-20"></div>
          </div>
          <div className="mx-auto max-w-2xl text-center">
            ...
            <div className="mt-10 flex items-center justify-center gap-x-6">
              <a
                href="#"
                className="rounded-md bg-white px-3.5 py-2.5 text-sm font-semibold text-gray-900 shadow-sm hover:bg-gray-100 box boy bpa bpm"
              >
                Get started
              </a>
              <a
